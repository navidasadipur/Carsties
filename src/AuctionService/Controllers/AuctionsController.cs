...
public class AuctionsController : ControllerBase
{
    ...
    [HttpGet("{id}")]
    public async Task<ActionResult<AuctionDto>> GetAucitonById(Guid id)
    {
        var acution = await _repo.GetAuctionByIdAsync(id);

        if (acution is null) return NotFound();
    ...
    public async Task<ActionResult<AuctionDto>> CreateAuction(CreateAuctionDto auctionDto)
    {
        ...
        return CreatedAtAction(nameof(GetAucitonById), 
